...
def keys_pressed(d_o_e=tkinter.Tk(useTk=0).dooneevent,
...
def remove_from_screen(x,
                       d_o_e=tkinter.Tk(useTk=0).dooneevent,
                       d_w=tkinter._tkinter.DONT_WAIT):
    _canvas.delete(x)
    d_o_e(d_w)
...
if __name__ == '__main__':
    ...
    move_to(g, (50, 50))
    circle((150, 150), 20, formatColor(0.7, 0.3, 0.0), formatColor(0, 0.5, 0), endpoints=[15, - 15])
    sleep(2)
